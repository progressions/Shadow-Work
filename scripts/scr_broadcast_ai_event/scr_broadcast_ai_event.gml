...
/// @param {String} type         The type of event (e.g., "EnemyDeath", "Noise", "MajorThreat")
/// @param {Real} x              The x-coordinate where the event occurred
/// @param {Real} y              The y-coordinate where the event occurred
