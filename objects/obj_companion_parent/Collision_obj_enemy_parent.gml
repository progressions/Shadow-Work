// Companion collision with enemy - hop out of the way
...
// Initialize enemy dodge cooldown if it doesn't exist
if (!variable_instance_exists(id, "enemy_dodge_cooldown")) {
    enemy_dodge_cooldown = 0;
}

// Only dodge if not on cooldown
if (enemy_dodge_cooldown > 0) {
    enemy_dodge_cooldown--;
    exit;
}

// Calculate dodge direction (away from enemy)
