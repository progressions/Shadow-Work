...
if (_hit_enemy != noone) {
    ...
    // Combine charge multiplier with range profile multiplier
    __proj_scaled_damage = damage * current_damage_multiplier * charge_multiplier;
    __proj_damage_multiplier = current_damage_multiplier;
    __proj_charge_multiplier = charge_multiplier;
    ...
    var _log_charge_mult = __proj_charge_multiplier;
    ...
    if (variable_global_exists("debug_mode") && global.debug_damage_reduction) {
        ...
        var _charge_mult_val = is_real(_log_charge_mult) ? _log_charge_mult : 1.0;
        ...
        show_debug_message("[Player Ranged] target=" + _target_name
            ...
            + " range_mult=" + string_format(_mult_val, 0, 3)
            + " charge_mult=" + string_format(_charge_mult_val, 0, 3)
    ...
    __proj_charge_multiplier = undefined;
